...
에이전트형 AI에서 간접 프롬프트 인젝션이 왜 구조적 문제인지, Lethal Trifecta와 Rule of Two로 어떻게 설계 경계를 나눌지 설명하는 발표 자료입니다.
...
<div class="deck-grid">
  <div class="card">
    ...
    <ul>
      ...
      <li>긴 컨텍스트와 다단계 작업에서는 지시 충돌과 오해가 누적됩니다.</li>
...
<div class="deck-grid">
  ...
  <div class="card">
    ...
    <ul>
      <li>외부 콘텐츠는 스키마 기반 필드 추출이나 요약으로만 전달합니다.</li>
...
<div class="deck-grid">
  <div class="card">
    <h3>어떻게 나누나</h3>
    <ul>
      <li>Planner는 신뢰된 사용자 요청만 읽습니다.</li>
      <li>Extractor는 비신뢰 콘텐츠만 읽고 구조화 결과만 냅니다.</li>
...
<div class="mini mt-4">실무 포인트: 추출 모델 출력은 JSON 스키마, 열거값, 최대 길이 제한처럼 해석 범위를 좁히는 편이 좋습니다.</div>
...
<div class="deck-grid">
  <div class="card">
    ...
    <ul>
      ...
      <li>그다음 별도 실행기가 허용된 단계만 실행합니다.</li>
  ...
  <div class="card">
    ...
    <ul>
      ...
      <li>승인 가능한 중간 산출물과 감사 로그가 필요한 조직 환경</li>
...
<div class="deck-grid">
  <div class="card">
    ...
    <ul>
      ...
      <li>실행기는 허용된 명령 집합만 해석하고, 그 외 표현은 거부합니다.</li>
...
<div class="deck-grid">
  ...
  <div class="card">
    ...
    <ul>
      ...
      <li>문서 단위 출처 기록과 감사 추적을 남기기 쉽습니다.</li>
      <li>대규모 검색·요약 작업에서 피해 범위를 줄이는 데 효과적입니다.</li>
    </ul>
  </div>
</div>
...
<div class="deck-grid">
  <div class="card">
    ...
    <ul>
      ...
      <li>선택기는 입력 출처, 데이터 민감도, 대상 도메인, 승인 상태를 함께 봅니다.</li>
      <li>필요하면 사람 승인 없이는 실행하지 않습니다.</li>
    </ul>
  </div>
  <div class="card">
    <h3>정책 엔진이 강제해야 할 것</h3>
    <ul>
      <li>외부 전송 허용 목록, 도구별 범위, 읽기/쓰기 분리, 요청 서명</li>
...
<div class="step-list">
  ...
  <div class="step"><span class="strong">2.</span> planner, extractor, executor를 분리하고 각자 도구 범위를 다르게 부여합니다.</div>
  <div class="step"><span class="strong">3.</span> 외부 전송과 상태변경 도구는 허용 목록, 승인, 감사 로그 뒤에 둡니다.</div>
  <div class="step"><span class="strong">4.</span> 구조화 출력, 제한된 스키마, 짧은 수명 메모리를 기본값으로 둡니다.</div>
