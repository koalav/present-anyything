import{_ as c}from"./slidev/CodeBlockWrapper.vue_vue_type_script_setup_true_lang-DIzOii7Y.js";import{o as r,b as o,w as e,g as n,d,m,D as s,v as u,x as g,z as l}from"./modules/vue-0DkHb0vD.js";import{I as f}from"./slidev/default-BNdF-7FD.js";import{u as k,f as v}from"./slidev/context-Ch9eZ4tg.js";import"./modules/unplugin-icons-CrxfDbIS.js";import"./index-fYzDbc13.js";import"./modules/shiki-BdEeu8M_.js";const w={__name:"slides.md__slidev_11",setup(P){const{$clicksContext:i,$frontmatter:t}=k();return i.setup(),(_,a)=>{const p=c;return r(),o(f,u(g(l(v)(l(t),10))),{default:e(()=>[a[1]||(a[1]=n("h1",null,"예시 Output: 터미널",-1)),d(p,m({},{title:"",ranges:[]}),{default:e(()=>[...a[0]||(a[0]=[n("pre",{class:"shiki shiki-themes vitesse-dark vitesse-light slidev-code",style:{"--shiki-dark":"#dbd7caee","--shiki-light":"#393a34","--shiki-dark-bg":"#121212","--shiki-light-bg":"#ffffff"}},[n("code",{class:"language-text"},[n("span",{class:"line"},[n("span",null,"$ semgrep scan --metrics=off --config rules/android-local.yml app/src/main")]),s(`
