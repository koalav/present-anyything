import{_ as r}from"./slidev/CodeBlockWrapper.vue_vue_type_script_setup_true_lang-CmppNrb-.js";import{o,b as c,w as e,g as s,d as u,m as d,ad as a,v as m,x as f,T as l}from"./modules/vue-Dc0l4PFH.js";import{I as g}from"./slidev/default-DHLH9_nG.js";import{u as k,f as _}from"./slidev/context-DgJ8Ga0Z.js";import"./modules/unplugin-icons-BCtJsVwl.js";import"./index-BCvrHjQh.js";import"./modules/shiki-BSw8WxP7.js";const B={__name:"slides.md__slidev_19",setup(h){const{$clicksContext:t,$frontmatter:i}=k();return t.setup(),(v,n)=>{const p=r;return o(),c(g,m(f(l(_)(l(i),18))),{default:e(()=>[n[1]||(n[1]=s("h1",null,"예시 2: AI 검토 입력 템플릿",-1)),u(p,d({},{title:"",ranges:[]}),{default:e(()=>[...n[0]||(n[0]=[s("pre",{class:"shiki shiki-themes vitesse-dark vitesse-light slidev-code",style:{"--shiki-dark":"#dbd7caee","--shiki-light":"#393a34","--shiki-dark-bg":"#121212","--shiki-light-bg":"#ffffff"}},[s("code",{class:"language-text"},[s("span",{class:"line"},[s("span",null,"다음 Semgrep finding이 실제 취약점인지, 오탐인지 Java 코드리뷰 관점에서 판별해줘.")]),a(`
