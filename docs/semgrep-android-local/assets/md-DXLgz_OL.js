import{_ as o}from"./slidev/CodeBlockWrapper.vue_vue_type_script_setup_true_lang-BD5UGRko.js";import{o as r,b as c,w as e,g as n,d as u,m as d,ad as s,v as m,x as g,T as a}from"./modules/vue-Dc0l4PFH.js";import{I as f}from"./slidev/default-pf3n8IS4.js";import{u as _,f as k}from"./slidev/context-CedXwbji.js";import"./modules/unplugin-icons-BCtJsVwl.js";import"./index-CD9SBIuW.js";import"./modules/shiki-BSw8WxP7.js";const v={__name:"slides.md__slidev_13",setup(I){const{$clicksContext:t,$frontmatter:i}=_();return t.setup(),(x,l)=>{const p=o;return r(),c(f,m(g(a(k)(a(i),12))),{default:e(()=>[l[1]||(l[1]=n("h1",null,"예시 1: AI 검토 입력 템플릿",-1)),u(p,d({},{title:"",ranges:[]}),{default:e(()=>[...l[0]||(l[0]=[n("pre",{class:"shiki shiki-themes vitesse-dark vitesse-light slidev-code",style:{"--shiki-dark":"#dbd7caee","--shiki-light":"#393a34","--shiki-dark-bg":"#121212","--shiki-light-bg":"#ffffff"}},[n("code",{class:"language-text"},[n("span",{class:"line"},[n("span",null,"다음 Semgrep finding이 실제 취약점인지, 오탐인지 Android 코드리뷰 관점에서 판별해줘.")]),s(`
